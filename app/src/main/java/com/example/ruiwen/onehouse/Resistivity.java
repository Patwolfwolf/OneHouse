...
public class Resistivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_resistivity);
    ...
    public void clickButton(){
        ...
        calBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cs.length() == 0 && resistivity.length() != 0 && resistance.length() != 0 && length.length() != 0){
                ...
                if(length.length() == 0 && resistivity.length() != 0 && resistance.length() != 0 && cs.length() != 0){
